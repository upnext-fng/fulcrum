...
// Logger wraps the fulcrum logger to implement Echo's logger interface
type Logger struct {
	*logger.Logger
	prefix string
	level  zapcore.Level
...
func NewEchoLogger(l *logger.Logger) *Logger {
	return &Logger{
		Logger: l,
		prefix: "",
		level:  zap.InfoLevel,
...
func (l *Logger) SetHeader(h string) {
	l.WithFields(map[string]any{logger.LogFieldLogHeader: h})
}
